...
import com.seu.cose.easytrip.adapter.FolloweeViewAdapter;
...
@ContentView(R.layout.fragment_my_followee)
public class MyFolloweeFragment extends BaseAppFragment {

    private List<MessageViewContainer> mDatas=new ArrayList<>();
    private FolloweeViewAdapter recycleAdapter;

    @ViewInject(R.id.followeelist_recyclerview)
    ...
    public void  onActivityCreated(@Nullable Bundle saveInstanceState) {
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(MyFolloweeFragment.this.getActivity()));
        recycleAdapter = new FolloweeViewAdapter(MyFolloweeFragment.this.getActivity(), mDatas);
        //设置Adapter
