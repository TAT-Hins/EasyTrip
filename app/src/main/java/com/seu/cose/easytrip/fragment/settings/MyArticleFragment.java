...
import com.seu.cose.easytrip.Override.MyArticleViewAdapter;
...
public class MyArticleFragment extends BaseAppFragment {
    ...
    private MyArticleViewAdapter myArticleViewAdapter;
    ...
    public void  onActivityCreated(@Nullable Bundle saveInstanceState) {
        ...
        myArticleViewAdapter = new MyArticleViewAdapter(this.getActivity(), cards);
        mRecyclerView.setAdapter(myArticleViewAdapter);
